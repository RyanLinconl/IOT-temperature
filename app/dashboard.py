...
engine = create_engine('postgresql://postgres:coio1234@localhost:5432/postgres')
...
fig2 = px.line(df_leituras_hora, x='hour', y='avg_temp')
...
fig3 = px.line(df_temp_max_min, x='data', y=['max_temp', 'min_temp'])
